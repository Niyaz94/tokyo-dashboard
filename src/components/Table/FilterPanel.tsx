...
import {
  Box,Collapse,Button,IconButton,Typography,Paper,Stack,Divider,
} from "@mui/material";
...
const FilterPanel = ({ filters, handleFilterChange, filterFields }) => {
  ...
  // console.log(filters, filterFields)



  const filterContent=useMemo(()=>{
    return (<Stack direction="row" flexWrap="wrap" spacing={2} useFlexGap sx={{mt: 1,px:2, justifyContent: "flex-start"}}>
          {
