...
const CollapsibleForm = () => {
  ...
  const saveReturn=()=>{
    handleSave().then(()=>navigate('/management/repeat'))
  }
  const saveContinue=()=>{
        ...
        <CardContent>
          ...
          >
            <Grid container spacing={2}>
              ...
              <Grid size={12}>
                <MultiButton type={edit_page_id ?"edit":"insert"} saveContinue={saveContinue} saveReturn={saveReturn} returnUrl={'/management/repeat'}/>
              </Grid>
            </Grid>
