...
export const expenseFormFields = (dynamicData:any)=>[
    ...
    { fieldType:"form",size:6,type: "date", key: "adate", label: "Purchase Date" },
    { fieldType:"form",size:4, type: "number", key: "amount", label: "Expense Amount",min:0 ,max:100000000,required:true},
    { fieldType:"form",size:4, type: "number", key: "wastedAmount", label: "Wasted Amount",min:0 ,max:100000000,required:true},  
    { fieldType:"form",size:4,type: "autocomplete", key: "spendingType", label: "Spending Type", options: ExpenseSpendingType },
