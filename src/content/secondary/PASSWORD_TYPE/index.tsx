...
export default () =>{
  ...
  const { data,success}: FetchData<PageTypeSingleSampleInterface[]> = useFetch <PageTypeSingleSampleInterface[]>('document/password/type',[]);
  ...
  return (
    <PageProvider tableData={data}>
      <Template templateTitle="Secondary - Password Type">
        <Routes>
