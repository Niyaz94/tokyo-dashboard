...
const CollapsibleForm = () => {
  ...
  const { data:fetchEditData,success:editReturnSuccess}: FetchData<FormIntialStateInterface>  = useFetch <FormIntialStateInterface>(edit_page_id ?`document/learn/type/${edit_page_id}`: null,{});
  ...
  const handleSave = async () => {
    ...
    if (edit_page_id) {
      await editData(`document/learn/type/${edit_page_id}/`, formData);
    }else{
      await postData("document/learn/type/", dataToBeSent,"FORM");
    }
  };
