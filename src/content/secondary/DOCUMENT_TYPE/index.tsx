...
export default () =>{
  ...
  const { data,success}: FetchData<PageTypeSingleSampleInterface[]> = useFetch <PageTypeSingleSampleInterface[]>('document/document/type',[]);
  ...
  return (
    <PageProvider tableData={data}>
      <Template templateTitle="Secondary - Document Types">
        <Routes>
