...
const CollapsibleForm = () => {
  ...
  const { data:fetchEditData,success:editReturnSuccess}: FetchData<FormIntialStateInterface>  = useFetch <FormIntialStateInterface>(edit_page_id ?`document/document/type/${edit_page_id}`: null,{});
  ...
  const handleSave = async () => {
    ...
    if (edit_page_id) {
      await editData(`document/document/type/${edit_page_id}/`, formData);
    }else{
      await postData("document/document/type/", dataToBeSent,"FORM");
    }
  };
