...
export const todayFormFields = [
    ...
    { fieldType:"form",size:6, type: "text", key: "pray", label: "Pray Pattern"}, 
    { fieldType:"form",size:6, type: "text", key: "meditation", label: "Meditation Patern"}, 

    { fieldType:"form",size:2,type: "switch", key: "isBusyDay", label: "Is Busy Day" },
    { fieldType:"form",size:2,type: "switch", key: "isMeditation", label: "Is Meditation" },
    { fieldType:"form",size:3,type: "switch", key: "isListenToMusic", label: "Is Listen To Music" },
    { fieldType:"form",size:2,type: "switch", key: "beingGrateful", label: "Being Grateful"},
    { fieldType:"form",size:3,type: "threeStateSwitch", key: "successStatus", label: "Success Status"},
