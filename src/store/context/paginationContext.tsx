...
export const PaginationProvider  = ({ children,tableData, secondaryData,paginData}) => {
  ...
  return (
    <PaginationContext.Provider value={{ table, setTable, secondary, setSecondary, pagination, setPagination }}>
      {children}
